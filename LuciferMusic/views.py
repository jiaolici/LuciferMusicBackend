...
from .models import UserProfile,Artist,Album,Song,SongList
from .serializers import UserSerializer,ArtistSerializer,AlbumSerializer,SongSerializer,SongListSerializer
